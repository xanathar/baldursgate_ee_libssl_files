...
#===============================================================================
# install_icewind_dale_desktop.sh
#
# Description:
#   This script installs an SSL compatibility fix for GOG's Icewind Dale:
...
#
# What it does:
#   - Checks to see if Icewind Dale is installed in the default GOG directory
...
#   chmod +x install_icewind_dale_desktop.sh
# Then run script:
#   bash install_icewind_dale_desktop.sh
#
...
# Define paths
#----------------------------------------
GAME_DIR="$HOME/GOG Games/Icewind Dale Enhanced Edition"
DESKTOP_DIR="$HOME/Desktop"
DESKTOP_FILE="$DESKTOP_DIR/icewind_dale.desktop"
...
Comment=Launches IWD with SSL fix (libssl 1.0)
