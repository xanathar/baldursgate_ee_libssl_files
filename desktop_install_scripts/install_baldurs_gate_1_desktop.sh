...
#===============================================================================
# install_baldurs_gate_1_desktop.sh
#
# Description:
#   This script installs an SSL compatibility fix for GOG's Baldur's Gate I:
...
#
# What it does:
#   - Checks to see if Baldurs Gate 1 is installed in the default GOG directory
...
#   chmod +x install_baldurs_gate_1_desktop.sh
# Then run script:
#   bash install_baldurs_gate_1_desktop.sh
#
...
# Define paths
#----------------------------------------
GAME_DIR="$HOME/GOG Games/Baldurs Gate Enhanced Edition"
DESKTOP_DIR="$HOME/Desktop"
DESKTOP_FILE="$DESKTOP_DIR/baldurs_gate_i.desktop"
...
GenericName=Baldur's Gate I: Enhanced Edition
Comment=Launches BG1:EE with SSL fix (libssl 1.0)
