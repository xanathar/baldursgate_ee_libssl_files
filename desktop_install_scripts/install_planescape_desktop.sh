...
#===============================================================================
# install_planescape_desktop.sh
#
# Description:
#   This script installs an SSL compatibility fix for GOG's Planescape Torment:
...
#
# What it does:
#   - Checks to see if Planescape is installed in the default GOG directory
...
#   chmod +x install_planescape_desktop.sh
# Then run script:
#   bash install_planescape_desktop.sh
#
...
# Define paths
#----------------------------------------
GAME_DIR="$HOME/GOG Games/Planescape Torment Enhanced Edition"
DESKTOP_DIR="$HOME/Desktop"
DESKTOP_FILE="$DESKTOP_DIR/planescape.desktop"
...
GenericName=Planescape Torment: Enhanced Edition
Comment=Launches Planescape with SSL fix (libssl 1.0)
